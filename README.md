...
The Farm can have 1 or more Environments. Each Environment has its own temperature, humidity, and light schedule. If you have multiple rooms or multiple tents, each one is a separate environment. Each environment runs on a Raspberry Pi RP2040 with a MCP25625 CAN Controller chip.
