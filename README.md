...
This project is written by humans the old fashioned way. LLMs are utilized primarily as a search engine in the style of Stack Overflow, but any purely AI generated code will be listed below:
